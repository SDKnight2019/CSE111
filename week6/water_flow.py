...
def main():
    ...
    pressure += pressure_loss_from_pipe_reduction(diameter, HOUSEHOLD_VELOCITY, reynolds, HDPE_SDR11_INNER_DIAMETER)
    ...
    print(f"Pressure at house: {pressure_kpa_to_psi(pressure):.1f} psi")
